...
function clueAlert() {
  alert("Whatever you picked, it doesn't matter. The clue key is:\n\nFirst of all of all of all clue keys.");	
}

var awesomeQuestion = "Are words really fabulous? <button style='background-color:black;border-color:crimson;color:white;' onclick='clueAlert()'>Yes</button> <button onclick='clueAlert()' style='background-color:black;border-color:crimson;color:white;'>No</button>";